...
public class MtsMenusLists {
    ...
    private RichSelectOneChoice fontSize;
    private String currentFontSize;
    private RichSelectBooleanCheckbox saveAsPrefChk;
    private RichSelectOneChoice localValue;
    private RichSelectOneChoice skinValue;
    private RichSelectOneChoice templateValue;
...
*/
    public void setFontSize(RichSelectOneChoice fontSize) {
        this.fontSize = fontSize;
    }

    public RichSelectOneChoice getFontSize() {
        return fontSize;
    }

    public void setCurrentFontSize(String currentFontSize) {
        String fontSize = "smallFont";
        if (ADFContext.getCurrent().getSessionScope().get("fontSize") != null) {
            fontSize = (String) ADFContext.getCurrent().getSessionScope().get("fontSize");
        }
        this.currentFontSize = fontSize;
    }

    public String getCurrentFontSize() {
        //    System.out.println(fontSize.getValue());
        //    return  fontSize!=null? fontSize.getValue().toString():"smallFont";
    ...
    public void setSaveAsPrefChk(RichSelectBooleanCheckbox saveAsPrefChk) {
        this.saveAsPrefChk = saveAsPrefChk;
    }

    public RichSelectBooleanCheckbox getSaveAsPrefChk() {
        return saveAsPrefChk;
    }

    public void setLocalValue(RichSelectOneChoice localValue) {
        this.localValue = localValue;
    }

    public RichSelectOneChoice getLocalValue() {
        return localValue;
    }

    public void setSkinValue(RichSelectOneChoice skinValue) {
        this.skinValue = skinValue;
    }

    public RichSelectOneChoice getSkinValue() {
        return skinValue;
    }

    public void setTemplateValue(RichSelectOneChoice templateValue) {
        this.templateValue = templateValue;
    }

    public RichSelectOneChoice getTemplateValue() {
