...
public class JSFUtils {
    ...
    public static ValueExpression resolveExpressionAsExpression(String expression) {
        FacesContext facesContext = getFacesContext();
        Application app = facesContext.getApplication();
        ExpressionFactory elFactory = app.getExpressionFactory();
        ELContext elContext = facesContext.getELContext();
   ...
   public static FacesMessage getMessageFromBundle(String key, FacesMessage.Severity severity,String ClientId) {
        ResourceBundle bundle = getBundle();
        String summary = getStringSafely(bundle, key, null);
        String detail = getStringSafely(bundle, key + "_detail", summary);
    ...
    */
    ...
    public static void showPopup(String popId) {
        RichPopup popup = (RichPopup) findComponentInRoot(popId);
        if (popup != null) {
    ...
    public static void hidePopup(String popId) {
        RichPopup popup = (RichPopup) findComponentInRoot(popId);
        if (popup != null) {
            popup.hide();
        }
